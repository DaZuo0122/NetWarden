...
//!
//! This module provides data structures and statistics tracking for TCP ping operations.
...
//! 
//! ## Key Structures
//! - [`PingResult`]: Result of a single probe
//! - [`Summary`]: Roll-up of an entire probing session  
//! - [`Stats`]: Mutable accumulator used during a session
//! 
//! ## Main Functions
//! - [`Stats::new`]: Create a new statistics accumulator
//! - [`Stats::feed`]: Feed a probe result and get a PingResult for formatting
//! - [`Stats::summary`]: Generate final summary statistics
//! - [`Stats::exit_code`]: Calculate exit code based on results
