...
//! 
//! This module provides different output formatting options for the TCP ping results.
//! It includes implementations for various formats like normal text, JSON, CSV, Markdown, and colored output.
//! 
//! ## Available Formatters
//! - [`Normal`]: Plain text output
...
//! 
//! ## Key Components
//! - [`Formatter`]: Trait that defines the formatting interface
//! - [`from_mode`]: Factory function to create formatters based on output mode
