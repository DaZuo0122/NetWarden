...
//!
//! This module provides the core engine functionality for the TCP ping utility.
//! 
//! Features:
...
//! 
//! ## Main Functions
//! - [`run`]: Synchronous entry point that creates a Tokio runtime and runs the async engine
//! - [`run_async`]: Asynchronous engine that handles the full TCP ping session
use crate::{
    cli::{Args, OutputMode},
